...
2. [缓存雪崩、穿透](https://mp.weixin.qq.com/s?__biz=MzUzMTA2NTU2Ng==&mid=2247487572&idx=1&sn=cdb757ef762f7113938a6f74e24dcf66)
...
百度通过 Expires 响应头控制logo有效期，有效期内缓存本地，浏览器只负责读取Expires来确认是否请求服务端，Expires在cdn与nginx进行设置。
...
1. [Redis布隆过滤器与布谷鸟过滤器](https://www.cnblogs.com/Courage129/p/14337466.html)
...
1. 删缓存还是更新缓存？
   		1. 删除，因为有的缓存需要计算。
      		1. 会带来下一次查询cache miss，可能存在缓存击穿情况，通过加锁解决。
