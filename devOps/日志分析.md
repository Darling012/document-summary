...
1. slf4j
   ...
   2. log4j2
      ...
      2. https://juejin.cn/post/6945753017878577165
...
1. 跨线程　　TaskDecorator
2. 跨jvm 　　http调用拦截器
3. https://blog.csdn.net/lujia_loney/article/details/91417898  关于子线程继承父线程mdc描述错误([Sleuth+MDC](https://segmentfault.com/a/1190000041480530)中说早期版本采用threadLocal，中间采用InheritableThreadLocal，后又因性能改为threadLocal。[ThreadLocal、InheritableThreadLocal、TransmittableThreadLocal三者区别](https://www.jianshu.com/p/a3134d70acf7))
...
3. 异常
   ...
   1. 自定义异常打印工具类
   2. commons.lang3.exception.ExceptionUtils
